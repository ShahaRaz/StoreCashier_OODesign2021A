...
public class CES_17 {
    ...
    private static void deleteStrFromFile(File file, String find) {
    ...
    private static void deleteStrFromFile2(File file, String find) {
        try (RandomAccessFile raf = new RandomAccessFile(file, "rw")) {
            int readPointer = 0;
            byte[] data = new byte[find.length()];
            while (raf.read(data) != -1) {
    ...
    private static void deleteStrFromFile3(File file, String find) {
        byte[] data = new byte[find.length()];
        try (RandomAccessFile raf = new RandomAccessFile(file, "rw")) {
            int read = 0;
            while (raf.read(data) != -1) {
